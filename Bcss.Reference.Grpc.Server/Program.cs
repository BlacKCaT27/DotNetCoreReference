                ...
                .ConfigureWebHostDefaults(webBuilder =>
                {
                    ...
                    webBuilder.UseKestrel()
                        ...
                        .ConfigureAppConfiguration((builderContext, config) =>
                        {
                            ...
                            /*
                             * Here we're adding four `IConfigurationProvider`s which are all provided by the framework.
                            ...
                            // It is possible to obtain a snapshot of the current configuration values by calling `Build()`, even while initializing
                            ...
                            config.AddAzureAppConfiguration(options =>
                            {
                               ...
                               options.Connect(settings["ConnectionStrings:AppConfig"])
                                   ...
                                   {
                                       refresh.Register("WeatherForecastSentinel", true)
